      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="group">
              <ScanLine className="w-10 h-10 text-[#510006] mb-6 group-hover:text-[#C5A47E] transition-colors" />
            ...
            <div className="group">
              <Camera className="w-10 h-10 text-[#510006] mb-6 group-hover:text-[#C5A47E] transition-colors" />
            ...
            <div className="group">
              <Zap className="w-10 h-10 text-[#510006] mb-6 group-hover:text-[#C5A47E] transition-colors" />
            ...
            <div className="group">
              <CheckCircle2 className="w-10 h-10 text-[#510006] mb-6 group-hover:text-[#C5A47E] transition-colors" />
